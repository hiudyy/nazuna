        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroupOrStatus && !isRetryResend) {
                ...
                for (const { user, device } of devices) {
                    const encodedLid = (0, WABinary_1.jidEncode)(user, "lid", device);
                ...
                const meLidUser = (_a = (0, WABinary_1.jidDecode)(meLid)) === null || _a === void 0 ? void 0 : _a.user;
                const isMe = (0, WABinary_1.areJidsSameUser)(user, meLidUser);
                ...
                if ((additionalAttributes === null || additionalAttributes === void 0 ? void 0 : additionalAttributes["category"]) === "peer" && isMe) {
            ...
            if (isRetryResend) {
                ...
                const participantDevice = (0, WABinary_1.jidDecode)(participant.jid).device;
                const [{ user: participantLidUser }] = await getUSyncDevices([participant.jid], true, false);
                const participantFulLid = (0, WABinary_1.jidEncode)(participantLidUser, "lid", participantDevice);
                ...
                const encodedMessageToSend = isMe
                    ...
                    : encodedMsg;
                const { type, ciphertext: encryptedContent } = await (0, Utils_1.encryptSignalProto)(participantFulLid, encodedMessageToSend, authState);
                binaryNodeContent.push({
                    tag: "enc",
                    attrs: {
                        v: "2",
            ...
            const innerMessage = ((_d = message.documentWithCaptionMessage) === null || _d === void 0 ? void 0 : _d.message) || message;

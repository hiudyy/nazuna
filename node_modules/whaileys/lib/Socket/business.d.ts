...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    requestPlaceholderResend: (messageKeys: {
        messageKey: import("../Types").WAMessageKey;
    }[]) => Promise<string>;
    getPrivacyTokens: (jids: string[]) => Promise<any>;
    getUSyncDevices: (jids: string[], useCache: boolean, ignoreZeroDevices: boolean) => Promise<import("../WABinary").JidWithDevice[]>;
    assertSessions: (jids: string[], force: boolean) => Promise<boolean>;
    relayMessage: (jid: string, message: import("../Types").WAProto.IMessage, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, statusJidList }: import("../Types").MessageRelayOptions) => Promise<string>;
    ...
    query: (node: import("../WABinary").BinaryNode, timeoutMs?: number | undefined) => Promise<any>;

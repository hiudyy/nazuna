...
const encryptedStream = async (media, mediaType, saveOriginalFileIfRequired = true, logger) => {
    ...
    const encFilePath = (0, path_1.join)(getTmpFilesDirectory(), mediaType + (0, generics_1.generateMessageID)() + "-enc");
    const encFileWriteStream = (0, fs_1.createWriteStream)(encFilePath);
    let originalFileStream;
    let originalFilePath;
    if (saveOriginalFileIfRequired) {
        originalFilePath = (0, path_1.join)(getTmpFilesDirectory(), mediaType + (0, generics_1.generateMessageID)() + "-original");
    ...
    try {
        ...
        (_b = originalFileStream === null || originalFileStream === void 0 ? void 0 : originalFileStream.destroy) === null || _b === void 0 ? void 0 : _b.call(originalFileStream, error);
        aes.destroy(error);
        hmac.destroy(error);
        ...
        await fs_1.promises
            .unlink(encFilePath)
            .catch(err => logger === null || logger === void 0 ? void 0 : logger.debug(err, "Error deleting enc temp file"));
        if (originalFilePath) {
            await fs_1.promises
                .unlink(originalFilePath)
                .catch(err => logger === null || logger === void 0 ? void 0 : logger.debug(err, "Error deleting original temp file"));
        }
        throw error;
    }
};
...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return async (filePath, { mediaType, fileEncSha256B64, timeoutMs }) => {
        ...
        for (const { hostname } of hosts) {
            ...
            let result;
            try {
                const body = await axios.post(url, (0, fs_1.createReadStream)(filePath), {
                    ...options,
                    maxRedirects: 0,
                    headers: {
                        ...(options.headers || {}),

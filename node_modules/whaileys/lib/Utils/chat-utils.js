...
const decodeSyncdMutations = async (msgMutations, initialState, getAppStateSyncKey, onMutation, validateMacs) => {
    ...
    for (const msgMutation of msgMutations) {
        ...
        const operation = "operation" in msgMutation
            ? msgMutation.operation
            : WAProto_1.proto.SyncdMutation.SyncdOperation.SET;
        const record = "record" in msgMutation && !!msgMutation.record
            ? msgMutation.record
            : msgMutation;
...
const decodePatches = async (name, syncds, initial, getAppStateSyncKey, onMutation, options, minimumVersionNumber, logger, validateMacs = true) => {
    var _a;
    syncds = [...syncds];
    ...
    while (syncds.length) {
        ...
        const shouldMutate = typeof minimumVersionNumber === "undefined" ||
            ...
            messageRange = {
                ...
                messages: (lastMessages === null || lastMessages === void 0 ? void 0 : lastMessages.length)
                    ? lastMessages.map(m => {
                        ...
                        if ((0, WABinary_1.isJidGroup)(m.key.remoteJid) &&
                            !m.key.fromMe &&
                            !m.key.participant) {
...
const processSyncAction = (syncAction, ev, me, initialSyncOpts, logger) => {
    ...
    if (action === null || action === void 0 ? void 0 : action.muteAction) {
        ...
        const msgRange = !(accountSettings === null || accountSettings === void 0 ? void 0 : accountSettings.unarchiveChats)
            ? undefined
            : archiveAction === null || archiveAction === void 0 ? void 0 : archiveAction.messageRange;
    ...
    else if ((action === null || action === void 0 ? void 0 : action.deleteMessageForMeAction) ||
    ...
    function isValidPatchBasedOnMessageRange(chat, msgRange) {
        const lastMsgTimestamp = (msgRange === null || msgRange === void 0 ? void 0 : msgRange.lastMessageTimestamp) ||

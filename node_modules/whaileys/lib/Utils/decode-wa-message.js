...
const decodeMessageStanza = (stanza, auth) => {
    ...
    let chatId;
    let author;
    const meLidUser = (_a = (0, WABinary_1.jidDecode)(auth.creds.me.lid)) === null || _a === void 0 ? void 0 : _a.user;
    ...
    const fromLidUser = (_b = (0, WABinary_1.jidDecode)(senderLid)) === null || _b === void 0 ? void 0 : _b.user;
    const fromDevice = (_c = (0, WABinary_1.jidDecode)(stanza.attrs.from)) === null || _c === void 0 ? void 0 : _c.device;
    const participantLidUser = (_d = (0, WABinary_1.jidDecode)(participantLid)) === null || _d === void 0 ? void 0 : _d.user;
    ...
    const participantFullLid = participantLidUser
        ? (0, WABinary_1.jidEncode)(participantLidUser, "lid", participantDevice)
        : undefined;
    const fromFullLid = !isGroup && fromLidUser
        ? (0, WABinary_1.jidEncode)(fromLidUser, "lid", fromDevice)
        : undefined;
    ...
    if ((0, WABinary_1.isJidUser)(from) || (0, WABinary_1.isLidUser)(from)) {
        ...
        msgType = "chat";
        author = isMe(from) ? (0, WABinary_1.jidEncode)(meLidUser, "lid", fromDevice) : from;
    }

...
import { AnyMediaMessageContent, AnyMessageContent, MediaGenerationOptions, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, VoteAggregation, WAMessage, WAMessageContent, WAProto } from "../Types";
 ...
 */
export declare function getAggregateVotesInPollMessage({ message, pollUpdates }: Pick<WAMessage, "pollUpdates" | "message">): VoteAggregation[];

 ...
 */
const extractUrlFromText = (text) => { var _a; return !Defaults_1.URL_EXCLUDE_REGEX.test(text) ? (_a = text.match(Defaults_1.URL_REGEX)) === null || _a === void 0 ? void 0 : _a[0] : undefined; };
...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const { mediaKey, originalFilePath, encFilePath, fileEncSha256, fileSha256, fileLength } = await (0, messages_media_1.encryptedStream)(uploadData.media, options.mediaTypeOverride || mediaType, requiresDurationComputation);
    ...
    await fs_1.promises
        .unlink(encFilePath)
        .catch(err => logger === null || logger === void 0 ? void 0 : logger.error(err, "Error deleting temp file"));
    logger === null || logger === void 0 ? void 0 : logger.debug("removed tmp encrypted file");
    if (originalFilePath) {
        await fs_1.promises
            .unlink(originalFilePath)
            .catch(err => logger === null || logger === void 0 ? void 0 : logger.error(err, "Error deleting temp file"));
        logger === null || logger === void 0 ? void 0 : logger.debug("removed tmp original file");
    }
...
const normalizeMessageContent = (content) => {
    ...
    content =
        ((_a = content === null || content === void 0 ? void 0 : content.editedMessage) === null || _a === void 0 ? void 0 : _a.message) ||
            ((_b = content === null || content === void 0 ? void 0 : content.lottieStickerMessage) === null || _b === void 0 ? void 0 : _b.message) ||
            ((_c = content === null || content === void 0 ? void 0 : content.documentWithCaptionMessage) === null || _c === void 0 ? void 0 : _c.message) ||
            ((_f = (_e = (_d = content === null || content === void 0 ? void 0 : content.ephemeralMessage) === null || _d === void 0 ? void 0 : _d.message) === null || _e === void 0 ? void 0 : _e.viewOnceMessage) === null || _f === void 0 ? void 0 : _f.message) ||
            ((_g = content === null || content === void 0 ? void 0 : content.ephemeralMessage) === null || _g === void 0 ? void 0 : _g.message) ||
            ((_h = content === null || content === void 0 ? void 0 : content.viewOnceMessage) === null || _h === void 0 ? void 0 : _h.message) ||
            ((_j = content === null || content === void 0 ? void 0 : content.viewOnceMessageV2Extension) === null || _j === void 0 ? void 0 : _j.message) ||
            ((_k = content === null || content === void 0 ? void 0 : content.viewOnceMessageV2) === null || _k === void 0 ? void 0 : _k.message) ||
            content ||
            undefined;
    return content;
};
 ...
 */
function getAggregateVotesInPollMessage({ message, pollUpdates }) {
    var _a, _b, _c;
    ...
    const voteHashMap = opts.reduce((acc, opt) => {
        const hash = (0, crypto_1.sha256)(Buffer.from(opt.optionName || "")).toString();
        acc[hash] = {
            name: opt.optionName || "",
            voters: []
        };

            ...
            for (const chat of item.conversations) {
                ...
                for (const item of msgs) {
                    ...
                    if ((message.messageStubType ===
                        Types_1.WAMessageStubType.BIZ_PRIVACY_MODE_TO_BSP ||
                        message.messageStubType ===
                            Types_1.WAMessageStubType.BIZ_PRIVACY_MODE_TO_FB) &&
                        ((_a = message.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0])) {
                        contacts.push({
                            id: message.key.participant || message.key.remoteJid,
                            verifiedName: (_b = message.messageStubParameters) === null || _b === void 0 ? void 0 : _b[0]
                        });
                    }
                }
...
const getHistoryMsg = (message) => {
    ...
    const normalizedContent = !!message
        ? (0, messages_1.normalizeMessageContent)(message)
        : undefined;

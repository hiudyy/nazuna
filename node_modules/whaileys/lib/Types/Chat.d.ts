...
export declare type WAPrivacyGroupAddValue = "all" | "contacts" | "contact_blacklist";
export declare type WAReadReceiptsValue = "all" | "none";
export declare type WAPrivacyCallValue = "all" | "known";
export declare type WAPrivacyMessagesValue = "all" | "contacts";
...
export declare type VoteAggregation = {
    name: string;
    voters: string[];
};

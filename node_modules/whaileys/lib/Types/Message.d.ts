...
declare type RequestPhoneNumber = {
...
export declare type AnyMediaMessageContent = (({
    ...
    mimetype: string;
    fileName?: string;
} & Buttonable & Contextable & Templatable)) & {
    mimetype?: string;
} & Editable;
...
export declare type InteractiveMessageContent = {
...
export declare type AnyRegularMessageContent = (({
    ...
    body?: string;
    footer?: string;
} | InteractiveMessageContent | RequestPhoneNumber) & ViewOnce;
...
export declare type WAMediaUploadFunction = (filePath: string, opts: {
